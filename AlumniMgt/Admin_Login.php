...
//mySQL Statement 
      $sql = mysqli_query($conn,"SELECT ad_fullname,ad_password FROM adminmem WHERE ad_fullname = '$userName';"); 
...
if ( false===$sql) {
  printf("error: %s\n", mysqli_error($conn));
    ...
    $resultU = ($row['ad_fullname']);
  $resultP =($row['ad_password']);
  //echo $resultP;
  //echo ".";
  //echo $pword;
  //echo ".";
